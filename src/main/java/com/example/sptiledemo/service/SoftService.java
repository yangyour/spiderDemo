...
public class SoftService {
    ...
    private static String desXlsPath = "C:\\Users\\31205\\Desktop\\数据处理文件\\7-17\\2017-2020系统合同台账.xls"; // 原文件路径
            ...
            for (int i = 1; i < sheet.getLastRowNum() + 1; i++) {
                ...
                if (null != row2.getCell(0) && !row2.getCell(0).toString().equals("")) {
                    ...
                    if (null != row2.getCell(6) && !row2.getCell(6).toString().equals("")) {
                        String els = row2.getCell(6).toString();
                        contract.setEls(els);
                    }
                    if (null != row2.getCell(9) && !row2.getCell(9).toString().equals("")) {
                        String rYear = row2.getCell(9).toString();
